    ...
    <div class="container">
        <div class="header">
            ...
            <div class="back-button">
                <a href="{{route('superadmin.dashboard')}}"><img src="/img/risalah-superadmin/Vector_back.png" alt=""></a>
            </div>
            <h1>Risalah Rapat</h1>
        </div>        
        <div class="row">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <button class="btn btn-success"><a href="{{route('add-risalah.superadmin')}}" style="text-decoration: none; color: #878790;">+ Add Risalah Rapat</a></button>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <div class="d-flex justify-content-center gap-3">
                            <button type="button" class="btn-cancel" data-bs-dismiss="modal"><a href="{{route ('risalah.superadmin')}}">Cancel</a></button>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <!-- Tombol -->
                        <button type="button" class="btn-back" data-bs-dismiss="modal"><a href="{{route ('risalah.superadmin')}}">Back</a></button>
                    </div>
                </div>
            </div>
        </div>
