...
@section('content')
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-sm2" data-bs-toggle="modal" data-bs-target="#deleteMemoModal"
                                data-memo-id="{{ $memo->id_memo }}"
                                data-route="{{ route('memo.delete', [$memo->id_memo, 'jenis_document' => 'memo']) }}">
                                <img src="/img/memo-superadmin/Delete.png" alt="delete">
                            </button>

                            @if ($memo->status == 'approve' || $memo->status == 'reject')
                                <form
                                    action="{{ route('arsip.archive', ['document_id' => $memo->id_memo, 'jenis_document' => 'Memo']) }}"
    ...
    <div class="modal fade" id="successArsipMemoModal" tabindex="-1" aria-labelledby="successArsipMemoModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content text-center p-4">
                <div class="modal-body">
    ...
    <div class="modal fade" id="deleteMemoSuccessModal" tabindex="-1" aria-labelledby="deleteSuccessModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content text-center p-4">
                <div class="modal-body">
    ...
    <div class="modal fade" id="noEditMemoModal" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content text-center p-4">
                <div class="modal-body">
                    <!-- Success Icon -->
                    <img src="/img/user-manage/success icon component.png" alt="Success Icon" class="mb-3"
                        style="width: 80px; height: 80px;">
                    <!-- Success Message -->
                    <h5 class="modal-title" id="successModalLabel"><b>Tidak Ada Perubahan</b></h5>
                    <p class="mt-2">Perubahan Tidak Tersimpan</p>
                </div>
            </div>
        </div>
    </div>
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            @if(session('success') === 'Memo updated successfully')
