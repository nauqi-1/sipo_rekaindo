...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('/css/superadmin/kirim-memoSuperadmin.css') }}">
</head>
<body>
    <div class="container">
        <div class="header">
        ...
        <div class="row">
            <div class="breadcrumb-wrapper">
                <div class="breadcrumb" style="gap: 5px;">
                    <a href="#">Home</a>/<a href="#">Memo</a>/<a href="#" style="color: #565656;">Kirim Memo</a>
                </div>
            </div>
        </div>
        <div class="card-body">
            <div class="row mb-4" style="gap: 20px;">
                <div class="col">
                    <div class="card-blue">
                        <label for="tgl_surat" class="form-label">
                            <img src="/img/memo-superadmin/info.png" alt="date">Informasi Detail Memo
                        </label>
                    </div>
                ...
                <div class="col">
                    <div class="card-blue">
                        <label for="tgl_surat" class="form-label">
                            <img src="/img/memo-superadmin/detail.png" alt="date" style="margin-right: 5px;">Detail
                        </label>
                    </div>
                    <div class="card-white">
                    ...
                    <div class="card-white">
                        ...
                        <div class="separator"></div>
                        <button class="view"> <img src="/img/memo-superadmin/view.png" alt="view">Lihat</button>
                        <button class="down"><img src="/img/memo-superadmin/down.png" alt="down">Unduh</button>
                    </div>
                </div>
            </div>
            <div class="row mb-4" style="gap: 20px;">
