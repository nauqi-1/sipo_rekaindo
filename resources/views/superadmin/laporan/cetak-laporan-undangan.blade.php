...
<head>
    ...
    <title>Laporan Undangan Rapat</title>
...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="breadcrumb-wrapper">
                <div class="breadcrumb">
                    <a href="#">Home</a>/<a href="#">Laporan</a>/<a style="color:#565656" href="#">Laporan Undangan Rapat</a>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h5><b>Laporan Undangan Rapat</b></h5>
            <div class="d-flex gap-2">
                ...
                <button class="btn btn-primary-print">
                    <img src="/img/laporan/print.png" alt="print"> Print Data
                </button>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content text-center p-4">
                <div class="modal-body">
                    ...
                    <h5 class="modal-title mb-4" id="deleteModalLabel">Hapus Laporan Undangan?</h5>
                    <!-- Buttons -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content text-center p-4">
                <div class="modal-body">
                    ...
                    <!-- Success Message -->
                    <h5><b>Berhasil Menghapus Laporan Undangan</b></h5>
                    <!-- Back Button -->
