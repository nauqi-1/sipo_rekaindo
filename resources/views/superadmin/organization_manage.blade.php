    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content text-center p-4">
            <div class="modal-body">
                ...
                <p class="mt-2">Berhasil Menambah Struktur Organisasi</p>
            </div>
        </div>
    </div>
</div>

<div class="modal fade" id="successEditDataPerusahaanModal" tabindex="-1" aria-labelledby="successModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content text-center p-4">
            <div class="modal-body">
                ...
                <!-- Success Message -->
                <h5 class="modal-title" id="successModalLabel"><b>Sukses</b></h5>
                <p class="mt-2">Berhasil Mengubah Struktur Perusahaan</p>
            </div>
        </div>
    </div>
</div>

<div class="modal fade" id="successDeleteDataPerusahaanModal" tabindex="-1" aria-labelledby="successModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content text-center p-4">
            <div class="modal-body">
                ...
                <!-- Success Message -->
                <h5 class="modal-title" id="successModalLabel"><b>Sukses</b></h5>
                <p class="mt-2">Berhasil Menghapus Struktur Perusahaan</p>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const typeSelect = document.getElementById('type'); // id select type
        const kodeInput = document.getElementById('kode');

        function toggleKodeRequired() {
            if (typeSelect.value === 'Director') {
        ...
        typeSelect.addEventListener('change', toggleKodeRequired);
        toggleKodeRequired(); // jalankan saat halaman pertama kali load
    });
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    if (res.ok && data.success) {
                        // Tampilkan modal sukses Bootstrap
                        const successModal = new bootstrap.Modal(
                            document.getElementById("successDeleteDataPerusahaanModal")
                        );
                        successModal.show();
                        ...
                        setTimeout(() => {
                            ...
                            modalInstance.hide();
                            location.reload(); // reload setelah modal ditutup
                        }, 1500);

                    } else {
                        Swal.fire('Gagal!', data.message || 'Tidak dapat menghapus data.', 'error');
                    }
                } catch (error) {
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (successMessage === 'Struktur Organisasi Berhasil Ditambahkan.') {
            var successModal = new bootstrap.Modal(document.getElementById("successAddDataPerusahaanModal"));
            successModal.show();
            setTimeout(function() {
                successModal.hide();
            }, 1500);
        } else if (successMessage === 'Struktur Organisasi Berhasil Diubah') {
            var successModal = new bootstrap.Modal(document.getElementById("successEditDataPerusahaanModal"));
            successModal.show();
            setTimeout(function() {
                successModal.hide();
            }, 1500);
        } else if (successMessage === 'Tidak ada perubahan data.') {
            ...
            document.getElementById("errorPasswordMessage").innerText = @json(session('error'));
