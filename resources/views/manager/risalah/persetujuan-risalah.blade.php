        ...
        <div class="row">
            <div class="breadcrumb-wrapper">
                <div class="breadcrumb" style="gap: 5px;">
                    <a href="#">Beranda</a>/<a href="{{route ('risalah.manager')}}">Risalah Rapat</a>/<a href="#" style="color: #565656;">Tindak Lanjut Risalah</a>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <!-- Tombol -->
                        <button type="button" class="btn backPage" data-bs-dismiss="modal"><a href="{{route ('risalah.manager')}}">Kembali</a></button>
                    </div>
                </div>
            </div>
        </div>
