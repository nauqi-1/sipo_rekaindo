...
<head>
    ...
    <title>Kirim Undangan Admin-Supervisor</title>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('/css/kirim/kirim-undangan.css') }}">
</head>
<body>
    <div class="container">
        <div class="header">
        ...
        <div class="row">
            <div class="breadcrumb-wrapper">
                <div class="breadcrumb" style="gap: 5px;">
                    <a href="#">Home</a>/<a href="#">Undangan Rapat</a>/<a href="#" style="color: #565656;">Kirim Undangan Rapat</a>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="row mb-4" style="gap: 20px;">
                ...
                <div class="col">
                    <div class="card-blue">Tindakan Selanjutnya</div>
                    <div class="card-white">
                ...
                <div class="col">
                    ...
                    <div class="card-white">
                        <select class="btn btn-dropdown dropdown-toggle d-flex justify-content-between align-items-center w-100" id="dropdownMenuButton">
                            ...
                            <option value="user">Jokowi</option>
                            <option value="user">Prabowo</option>
                        </select>                      
                    </div>
                </div>             
            </div>
