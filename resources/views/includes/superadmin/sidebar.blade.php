   ...
   <div class="navbar-wrapper">
     ...
     <div class="navbar-content">
       <ul class="pc-navbar">
         ...
         <li class="pc-item">
           <a href="{{ route(Auth::user()->role->nm_role . '.dashboard') }}" class="pc-link"><span class="pc-micon"><img src="/assets/images/ikon1.png" alt="" srcset=""></span><span class="pc-mtext">Dashboard</span></a>
         </li>
         ...
         @endif
         @if(Auth::user()->role->nm_role == 'manager')
         <li class="pc-item pc-hasmenu {{ request()->routeIs('memo.*') ? 'active' : '' }}">
           <a href="#!" class="pc-link">
             <span class="pc-micon"><img src="/assets/images/ikon3.png" alt=""></span>
             <span class="pc-mtext">Memo</span>
             <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
           </a>
           <ul class="pc-submenu">
             <li class="pc-item">
               <a class="pc-link {{ request()->is('memo-terkirim') ? 'active' : '' }}"
                 href="{{ route('memo.terkirim', Auth::user()->id) }}">
                 Memo Keluar
               </a>
             </li>
             <li class="pc-item">
               <a class="pc-link {{ request()->is('memo-diterima') ? 'active' : '' }}"
                 href="{{ route('memo.diterima', Auth::user()->id) }}">
                 Memo Masuk
               </a>
             </li>
         ...
         <li class="pc-item pc-hasmenu">
           <a href="#!" class="pc-link"><span class="pc-micon"><img src="/assets/images/ikon3.png" alt="" srcset=""></span><span class="pc-mtext">DCR</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span>
           </a>
           <ul class="pc-submenu">
         ...
         {{-- @if(Auth::user()->role->nm_role != 'manager') --}}
         <li class="pc-item pc-hasmenu">
           <a href="#!" class="pc-link"><span class="pc-micon"><img src="/assets/images/ikon5.png" alt="" srcset=""></span><span class="pc-mtext">Arsip</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span>
           </a>
           <ul class="pc-submenu">
         ...
         <li class="pc-item pc-hasmenu">
           <a href="#!" class="pc-link"><span class="pc-micon"><img src="/assets/images/ikon6.png" alt="" srcset=""></span><span class="pc-mtext">Laporan</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span>
           </a>
           <ul class="pc-submenu">
         ...
         <li class="pc-item pc-hasmenu">
           <a href="#!" class="pc-link"><span class="pc-micon"><img src="/assets/images/ikon7.png" alt="" srcset=""></span><span class="pc-mtext">Pengaturan</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span>
           </a>
           <ul class="pc-submenu">
         ...
         @if(Auth::user()->role->nm_role == 'superadmin')
         <li class="pc-item pc-hasmenu">
           <a href="#!" class="pc-link"><span class="pc-micon"><img src="/img/memo-superadmin/restore.png" alt="" srcset=""></span><span class="pc-mtext">Pemulihan</span><span class="pc-arrow"><i data-feather="chevron-right"></i></span>
           </a>
           <ul class="pc-submenu">
