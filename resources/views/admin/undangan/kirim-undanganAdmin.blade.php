        ...
        <div class="row">
            <div class="breadcrumb-wrapper">
                <div class="breadcrumb" style="gap: 5px;">
                    <a href="{{ route('admin.dashboard') }}">Beranda</a>/<a href="{{route('undangan.admin')}}">Undangan
                        Rapat</a>/<a href="#" style="color: #565656;">Kirim Undangan Rapat</a>
                </div>
            </div>
        </div>
        <form id="undanganSend" action="{{ route('documents.send') }}" method="POST">
                ...
                <div class="row mb-4" style="gap: 20px;">
                    <div class="col">
                        ...
                        <div class="card-white">
                            ...
                            <div class="separator"></div>
                            <input type="text" id="tgl" value="{{ $undangan->tgl_dibuat->translatedFormat('d F Y') }}"
                                readonly>
                        </div>
                        <div class="card-white">
                    ...
                    <div class="col">
                        ...
                        <div class="card-white">
                            ...
                            <input type="text" id="tgl-buat"
                                value="{{ $undangan->tgl_dibuat->translatedFormat('d F Y')}}" readonly>
                        </div>
                    </div>
                </div>
                <div class="row mb-4" style="gap: 20px;">
                    <div class="col">
                        <div class="card-blue1">
                            ...
                            <label for="isi" style="color: #FF000080; font-size: 10px; margin-left: 5px;">
                                *Pilih opsi posisi dan divisi tujuan untuk mengirimkan undangan kepada pihak yang
                                dituju.
                            </label>
                        </div>
                        ...
                        <div class="card-white">
                            ...
                            <div class="separator"></div>
                            <select name="posisi_penerima" id="posisi_penerima"
                                class="btn btn-dropdown dropdown-toggle d-flex justify-content-between align-items-center w-100"
                        ...
                        <div class="card-white">
                            ...
                            <div class="separator"></div>
                            <select name="divisi_penerima" id="divisi_penerima"
                                class="btn btn-dropdown dropdown-toggle d-flex justify-content-between align-items-center w-100"
                                id="dropdownMenuButton">
                                <option disabled selected style="text-align: left;">--Pilih--</option>
                                @foreach($divisi as $d)
            ...
            <div class="footer">
                <button type="button" class="btn back" id="backBtn"
                    onclick="window.location.href='{{ route('undangan.admin') }}'">Kembali</button>
                <button type="button" class="btn submit" id="submitBtn" data-bs-toggle="modal"
