        ...
        <div class="row">
            <div class="breadcrumb-wrapper">
                <div class="breadcrumb" style="gap: 5px;">
                    <a href="{{route('admin.dashboard')}}">Beranda</a>/<a href="#">Arsip</a>/<a style="color:#565656" href="#">Arsip Risalah Rapat</a>
                </div>
            </div>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{route ('arsip-viewRisalah.admin')}}" class="btn btn-sm3"><img src="/img/arsip/preview.png" alt="preview"></a>
                    </td>
                </tr>
                @endfor
            </tbody>
