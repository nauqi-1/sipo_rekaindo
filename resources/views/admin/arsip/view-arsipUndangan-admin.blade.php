...
<head>
    ...
    <title>View Arsip Undangan Admin</title>
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="back-button">
                <a href="{{route ('arsip-undangan.admin')}}"><img src="/img/user-manage/Vector_back.png" alt=""></a>
            </div>
        ...
        <div class="row">
            <div class="breadcrumb-wrapper">
                ...
                <a href="#">Arsip</a>/
                <a href="{{route ('arsip-undangan.admin')}}">Arsip Undangan</a>/
